...
public class Crate extends Quad implements Sprite {
	...
	public void animate(SpriteImageLoader loader) { frame = loader.getSingletonFrame(SpriteImageLoader.Crate_INDEX); }
