...
public class Book extends Quad implements Sprite {
	...
	public void animate(SpriteImageLoader loader) { frame = loader.getSingletonFrame(SpriteImageLoader.Book_INDEX); }
